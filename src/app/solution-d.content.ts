// Solution D — Environmental & Social Due Diligence. Dedicated body (replaces
// the MVP shortcut that reused the Solution A archetype content on this route).
// Three-zone skeleton (ia/v0 §2); E1: parent ESDD track record attributed only.
...
<header class="shero" id="top">
  ...
  <div class="wrap"><div class="shero-in">
    <span class="eyebrow reveal">Environmental &amp; Social Due Diligence</span>
    <h1><span class="hl-line">Find the risk before it prices the deal.</span></h1>
    <p class="lede reveal"><span class="g">ESDD</span> <i>(environmental and social due diligence)</i> aligned to the IFC Performance Standards and the Equator Principles — findings a deal team and a lender can both rely on, delivered on a <span class="g">deal timeline</span>, not an academic one.</p>
  ...
  <div class="scrollcue" aria-hidden="true"><div class="wrap"><b>Why E&amp;S risk is deal risk</b></div></div>
</header>
  ...
  <div class="wrap">
    <div class="prob-top">
      <div class="sec-head reveal" style="margin-bottom:0">
        ...
        <h2>Environmental and social findings now move price, terms and timing.</h2>
        <p>Lenders condition financing on E&amp;S compliance, investors carry portfolio obligations to their LPs, and liabilities that surface after close can fall to the buyer. Three pressures land at once.</p>
      </div>
    </div>
    <div class="pressure">
      <div class="pcard reveal"><div class="k">01 · THE LENDER</div><h4>Financing is conditional.</h4><p>Equator-aligned lenders and DFIs test projects against the IFC Performance Standards before money moves. An unassessed E&amp;S risk can become a condition precedent.</p></div>
      <div class="pcard reveal"><div class="k">02 · THE DEAL</div><h4>Liabilities can transfer at close.</h4><p>Legacy contamination, land and resettlement issues, labour and community exposure — what diligence does not surface, the buyer may inherit. Price protection starts with knowing.</p></div>
      <div class="pcard reveal"><div class="k">03 · THE LIFECYCLE</div><h4>Obligations outlive signing.</h4><p>E&amp;S conditions run for the life of the asset. Without a management system to carry them, findings become annual surprises instead of a closed action plan.</p></div>
    </div>
  </div>
</section>
...
<section class="sec" id="scope">
  <div class="wrap">
    ...
    <div class="steps4">
      <div class="s4 reveal"><div class="n">01 · SCREEN</div><h4>Scope to the risk</h4><p>Transaction screened and categorised against the IFC Performance Standards — so the diligence fits the deal, not a template.</p><div class="mout"><span class="mout-k">You get</span> A scoped diligence plan</div></div>
      <div class="s4 reveal"><div class="n">02 · DILIGENCE</div><h4>Desktop, then on-site</h4><p>A Desktop ESDD screens the data room and public record; a Site-based ESDD verifies it in the field — every material finding evidenced, mapped to the standard it relates to, and ranked by significance.</p><div class="mout"><span class="mout-k">You get</span> An evidenced findings set</div></div>
      <div class="s4 reveal"><div class="n">03 · REPORT</div><h4>Report for decisions</h4><p>Findings written for a deal team and a credit committee: what it is, what it costs to fix, what it means for terms.</p><div class="mout"><span class="mout-k">You get</span> A decision-ready findings report</div></div>
      <div class="s4 reveal"><div class="n">04 · MANAGE</div><h4>Close the actions</h4><p>An E&amp;S action plan and management system (HSESMS) so conditions get closed on schedule — for the life of the asset.</p><div class="mout"><span class="mout-k">You get</span> An E&amp;S action plan (ESAP)</div></div>
    </div>
  </div>
</section>
...
<section class="sec" id="proof">
  <div class="wrap">
    <div class="sec-head reveal" style="max-width:none;margin-bottom:34px">
      <span class="mono eyebrow" style="color:var(--gold-l)">Built for scrutiny — and we show how</span>
      <h2>Every material finding is evidenced, mapped to its standard, and ranked by significance, cost and decision relevance.</h2>
    </div>
    <div class="pb-grid">
      <div class="reveal">
        <p style="color:var(--n200);margin-bottom:18px">The diligence is mastered against the standards lenders and investors actually apply:</p>
        <div class="stds">
          <span class="std2"><b>IFC</b> PS 1–8</span>
          <span class="std2"><b>Equator</b> Principles</span>
          <span class="std2"><b>ESDD / HSESDD</b></span>
          <span class="std2"><b>HSESMS</b></span>
        </div>
      ...
      <div class="readycard reveal">
        ...
        <div class="rc-foot">BUILT ON THE ESDD TRACK RECORD OF THE ASSOCIATED PRACTICE, TERAVUE — ATTRIBUTED.</div>
      </div>
    </div>
...
<section class="sec tri" id="on-the-ground" aria-label="What the diligence actually examines">
  <div class="wrap">
...
<section class="sec prob" id="fit">
  <div class="wrap">
    <div class="sec-head reveal">
      ...
      <h2>Built for the tables where E&amp;S risk gets decided.</h2>
    </div>
    <div class="personas">
...
<section class="sec final" id="cta">
  <div class="wrap">
    <h2 class="reveal">Bring us the deal timeline.</h2>
    <p class="reveal">Tell us the transaction, the asset and the window. A specialist scopes the diligence to fit — a real person, not a form receipt.</p>
    <div class="hero-cta reveal">
...
<section class="sec" id="faq">
  <div class="wrap">
    <div class="sec-head reveal"><span class="mono eyebrow">Common questions</span><h2>ESDD, IFC PS &amp; Equator, briefly.</h2></div>
    <div class="faq reveal">
      <div class="qa"><button>What is ESDD, and how is it different from an EIA or ESIA? <span class="pl">+</span></button><div class="a">An EIA <i>(environmental impact assessment)</i> — or an ESIA, which adds the social dimension — assesses a proposed project's future impacts, usually for a consent. ESDD assesses an <i>existing</i> business or asset's environmental and social risks and liabilities — typically for a transaction or financing decision.</div></div>
