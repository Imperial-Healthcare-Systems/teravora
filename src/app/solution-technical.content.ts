// Solution — Technical & Environmental Services (Teravue catalog pillar 2 /
// service-line map Line C; client-directed catalog completion, 2026-07-14).
// Offering scope from research@v0 §1 only — copy authored fresh in the site
// voice. Three-zone skeleton (ia/v0 §2); E1-gated.
export const SOLUTION_TECHNICAL_BODY = String.raw`<div class="rails"><i></i></div>

<header class="shero" id="top">
  <div class="shero-bg" style="background-image:url('/v/solution/hero-technical.webp');background-position:center 45%"></div>
  ...
  <div class="wrap"><div class="shero-in">
    ...
    <div class="chips reveal">
      <span class="chip"><b>Energy · Water · Waste</b> audits</span>
      <span class="chip"><b>LCA</b> to ISO 14040 / 14044</span>
      <span class="chip"><b>EIA / ESIA</b> impact assessment</span>
      <span class="chip on"><b>ISO / IMS</b> implemented, not shelfware</span>
    </div>
  </div></div>
  <div class="scrollcue" aria-hidden="true"><div class="wrap"><b>Where the numbers actually come from</b></div></div>
</header>
...
<section class="sec" id="scope">
  <div class="wrap">
    <div class="sec-head reveal">
      ...
      <h2>From a walk of the plant to a certified, running system.</h2>
      <p>We measure on site, quantify what we find, and build the documentation and management systems that hold it — so the improvement survives the engagement.</p>
    </div>
...
<section class="sec" id="proof">
  <div class="wrap">
    ...
    <div class="pb-grid">
      <div class="reveal">
        <p style="color:var(--n200);margin-bottom:18px">The work is mastered against the technical standards that govern it:</p>
        <div class="stds">
          <span class="std2"><b>ISO</b> 14001 / 45001 / 9001</span>
          <span class="std2"><b>ISO</b> 14040 / 44 · LCA</span>
          <span class="std2"><b>EIA / ESIA</b></span>
          <span class="std2"><b>IMS</b> integrated systems</span>
        </div>
...
<section class="band" id="real-economy-band" aria-label="The plant floor behind the paperwork">
  <div class="band-img" style="background-image:url('/v/solution/band-technical.webp')"></div>
  <div class="band-scrim"></div>
  <div class="wrap band-in">
    <span class="mono band-kicker reveal">◇ THE REAL ECONOMY</span>
    <h2 class="band-h reveal">The numbers live<br>on the plant floor.</h2>
    <p class="band-sub reveal">Not in the template. Every credible figure starts at a meter, a weighbridge or a valve — which is where this work starts too.</p>
  </div>
</section>
...
<section class="sec prob" id="fit">
  <div class="wrap">
    <div class="sec-head reveal">
      ...
      <h2>Built for the people who run the site.</h2>
    </div>
    <div class="personas">
      <div class="pc2 reveal"><div class="ic">▲</div><h4>Operations &amp; EHS leaders</h4><p>Holding permits, consents and safety systems on a live site. We keep the compliance evidenced and the systems certifiable.</p><span class="lk">Request a Proposal →</span></div>
      <div class="pc2 reveal"><div class="ic">▤</div><h4>Manufacturers &amp; infrastructure</h4><p>Energy- and resource-intensive operations where audit findings convert directly into operating savings.</p><span class="lk">Request a Proposal →</span></div>
      <div class="pc2 reveal"><div class="ic">⬡</div><h4>Exporters &amp; suppliers</h4><p>Facing customer audits and certification requirements to stay on the vendor panel. We build systems that pass them.</p><span class="lk">Request a Proposal →</span></div>
    </div>
  </div>
</section>
...
<section class="sec final" id="cta">
  <div class="wrap">
    <h2 class="reveal">Bring us the site.</h2>
    <p class="reveal">Tell us the operation, the consents you hold and what is being asked of you. A specialist scopes a proposal — a real person, not a form receipt.</p>
    <div class="hero-cta reveal">
...
<section class="sec" id="faq">
  <div class="wrap">
    <div class="sec-head reveal"><span class="mono eyebrow">Common questions</span><h2>Audits, LCA &amp; management systems, briefly.</h2></div>
    <div class="faq reveal">
      <div class="qa"><button>What does an energy / water / waste audit deliver? <span class="pl">+</span></button><div class="a">A measured account of where energy, water or material actually goes on your site, the losses and their cost, and a ranked register of fixes with indicative paybacks — evidence first, recommendations second.</div></div>
