// Solution — Sustainable Finance & Carbon Markets (Teravue catalog pillar 3
// remainder / service-line map Line E; client-directed catalog completion,
// 2026-07-14). Offering scope from research@v0 §1 only — copy authored fresh in
// the site voice. Three-zone skeleton (ia/v0 §2); E1-gated (no market figures).
...
<header class="shero" id="top">
  ...
  <div class="wrap"><div class="shero-in">
    ...
    <div class="chips reveal">
      <span class="chip"><b>Green finance</b> readiness</span>
      <span class="chip"><b>ESG ratings</b> SEBI-regulated ERPs</span>
      <span class="chip"><b>Carbon markets</b> compliance &amp; voluntary</span>
      <span class="chip on"><b>Diligence-ready</b> evidence</span>
    </div>
  </div></div>
  <div class="scrollcue" aria-hidden="true"><div class="wrap"><b>Why sustainability moved into the CFO's office</b></div></div>
</header>
  ...
  <div class="wrap">
    <div class="prob-top">
      <div class="sec-head reveal" style="margin-bottom:0">
        ...
        <h2>Sustainability stopped being a report and became a term in the term sheet.</h2>
        <p>Lenders link pricing to ESG performance, ratings shape who gets capital, and carbon is becoming a priced instrument in India. Three pressures land at once.</p>
      </div>
    </div>
    <div class="pressure">
...
<section class="sec" id="scope">
  <div class="wrap">
    <div class="sec-head reveal">
      ...
      <h2>From a verifiable baseline to capital your sustainability actually earns.</h2>
      <p>We build the evidence base first, then structure the instrument, rating or market entry on top of it — in that order, because diligence reads it in that order.</p>
    </div>
...
<section class="sec" id="proof">
  <div class="wrap">
    <div class="sec-head reveal" style="max-width:none;margin-bottom:34px">
      <span class="mono eyebrow" style="color:var(--gold-l)">Built for diligence — and we show how</span>
      <h2>Every claim in the framework traces to a number your data room can defend.</h2>
    </div>
    <div class="pb-grid">
      <div class="reveal">
...
<section class="sec prob" id="fit">
  <div class="wrap">
    <div class="sec-head reveal">
      ...
      <h2>Built for the desks where sustainability meets capital.</h2>
    </div>
    <div class="personas">
      <div class="pc2 reveal"><div class="ic">₹</div><h4>CFOs &amp; treasury</h4><p>Weighing green or sustainability-linked financing and needing the evidence base to be worth the structuring cost.</p><span class="lk">Request a Proposal →</span></div>
      <div class="pc2 reveal"><div class="ic">▤</div><h4>Rated &amp; listed issuers</h4><p>Working to improve an ESG rating on evidence — closing the disclosure gaps raters actually score.</p><span class="lk">Request a Proposal →</span></div>
      <div class="pc2 reveal"><div class="ic">◆</div><h4>Carbon-project owners</h4><p>Assessing compliance or voluntary market entry, and needing the measurement basis to withstand integrity scrutiny.</p><span class="lk">Request a Proposal →</span></div>
    </div>
  </div>
</section>
...
<section class="sec final" id="cta">
  <div class="wrap">
    <h2 class="reveal">Bring us the financing question.</h2>
    <p class="reveal">Tell us the instrument, the rating or the market you are weighing — and where your data stands. A specialist scopes a proposal — a real person, not a form receipt.</p>
    <div class="hero-cta reveal">
...
<section class="sec" id="faq">
  <div class="wrap">
    <div class="sec-head reveal"><span class="mono eyebrow">Common questions</span><h2>Sustainable finance &amp; carbon markets, briefly.</h2></div>
