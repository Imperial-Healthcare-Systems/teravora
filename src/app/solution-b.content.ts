...
<header class="shero" id="top">
  ...
  <div class="wrap"><div class="shero-in">
    ...
    <p class="lede reveal">A <span class="g">GHG inventory</span> <i>(greenhouse-gas footprint across Scopes 1, 2 and 3)</i> built to the GHG Protocol, a decarbonisation pathway a board can approve, and climate disclosure aligned to <span class="g">IFRS S2, which incorporates the TCFD recommendations</span> — every figure traceable to its activity data.</p>
    ...
    <div class="chips reveal">
      <span class="chip"><b>GHG Protocol</b> Scopes 1 · 2 · 3</span>
      <span class="chip"><b>IFRS S2</b> climate disclosure</span>
      <span class="chip"><b>Scope 3</b> full value chain</span>
  ...
  <div class="wrap">
    <div class="prob-top">
      <div class="sec-head reveal" style="margin-bottom:0">
        ...
        <p>Emissions and energy sit inside the KPIs India's disclosure regime increasingly subjects to independent scrutiny — and customers, lenders and boards are asking for the working, not the summary. Three pressures land at once.</p>
      </div>
    </div>
    <div class="pressure">
      <div class="pcard reveal"><div class="k">01 · THE REGULATOR</div><h4>Checked, not asserted.</h4><p>Greenhouse gases and energy are attributes of BRSR Core — the subset of India's mandated disclosure subject to independent assessment or assurance. A footprint that can't be traced to activity data is where that stalls.</p></div>
...
<section class="sec" id="scope">
  <div class="wrap">
    <div class="sec-head reveal">
      ...
      <h2>From fuel bills and activity data to a board-approvable pathway.</h2>
    ...
    <div class="steps4">
      <div class="s4 reveal"><div class="n">01 · MEASURE</div><h4>Build the inventory</h4><p>Scopes 1, 2 and 3 to the GHG Protocol — boundaries set, factors sourced and versioned, every line traced to activity data.</p><div class="mout"><span class="mout-k">You get</span> A GHG inventory</div></div>
      <div class="s4 reveal"><div class="n">02 · TARGET</div><h4>Set the trajectory</h4><p>A baseline your board can sign, and reduction targets grounded in what your operations can actually deliver.</p><div class="mout"><span class="mout-k">You get</span> A board-signed baseline &amp; targets</div></div>
      <div class="s4 reveal"><div class="n">03 · CUT</div><h4>Plan the reductions</h4><p>Interventions ranked by abatement and cost — energy, process and procurement levers in one sequenced pathway.</p><div class="mout"><span class="mout-k">You get</span> A costed reduction pathway</div></div>
      <div class="s4 reveal"><div class="n">04 · DISCLOSE</div><h4>Report it credibly</h4><p>Climate disclosure aligned to IFRS S2 (incorporating the TCFD recommendations), consistent with your BRSR — written for the reader who checks.</p><div class="mout"><span class="mout-k">You get</span> Climate disclosure, S2-consistent</div></div>
    </div>
  </div>
</section>
...
<section class="band" id="real-economy-band" aria-label="The real economy behind the footprint">
  ...
  <div class="wrap band-in">
    ...
    <h2 class="band-h reveal">Every tonne on the page<br>traces to an activity, source and calculation.</h2>
...
<section class="sec prob" id="fit">
  <div class="wrap">
    ...
    <div class="personas">
      ...
      <div class="pc2 reveal"><div class="ic">▤</div><h4>Listed companies</h4><p>Carrying GHG and energy KPIs into scope for assessment or assurance, and answering climate questions from the board and investors.</p><span class="lk">Request a Proposal →</span></div>
...
<section class="sec final" id="cta">
  <div class="wrap">
    <h2 class="reveal">Bring us your activity data.</h2>
...
<section class="sec" id="faq">
  <div class="wrap">
    ...
    <div class="faq reveal">
      ...
      <div class="qa"><button>Is a GHG inventory mandatory for us? <span class="pl">+</span></button><div class="a">If you are in India's top-1,000 listed companies, greenhouse-gas and energy disclosure is part of your BRSR — and within BRSR Core it is phased into independent assessment or assurance by market-cap band. Unlisted suppliers increasingly face the same ask contractually, from customers.</div></div>
