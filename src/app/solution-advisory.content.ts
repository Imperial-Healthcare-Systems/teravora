// Solution — Sustainability, ESG & Climate Strategy Advisory (Teravue catalog
// pillar 1; client-directed catalog completion, 2026-07-14). Offering scope from
// research@v0 §1 only — all copy authored fresh in the site voice (no parent
// copy consulted or reused). Three-zone skeleton (ia/v0 §2); E1-gated.
...
<header class="shero" id="top">
  ...
  <div class="wrap"><div class="shero-in">
    <span class="eyebrow reveal">ESG &amp; Climate Strategy Advisory</span>
    <h1><span class="hl-line">An ESG strategy your operations can actually run.</span></h1>
    <p class="lede reveal">We embed ESG and climate into <span class="g">governance, strategy and operations</span> — starting from a <span class="g">materiality assessment</span> <i>(what genuinely matters to your business and its stakeholders)</i>, ending in a board-approvable roadmap with named owners.</p>
  ...
  <div class="scrollcue" aria-hidden="true"><div class="wrap"><b>Why strategy decks fail on the plant floor</b></div></div>
</header>
...
<section class="sec" id="proof">
  <div class="wrap">
    <div class="sec-head reveal" style="max-width:none;margin-bottom:34px">
      <span class="mono eyebrow" style="color:var(--gold-l)">Strategy you can operate — and we show how</span>
      <h2>Every priority carries a business reason, an owner and a measure.</h2>
    </div>
    <div class="pb-grid">
      <div class="reveal">
...
<section class="sec tri" id="on-the-ground" aria-label="What the strategy must survive">
  <div class="wrap">
...
<section class="sec prob" id="fit">
  <div class="wrap">
    <div class="sec-head reveal">
      ...
      <h2>Built for the teams asked "what is our ESG position?"</h2>
    </div>
    <div class="personas">
      <div class="pc2 reveal"><div class="ic">▤</div><h4>Listed companies</h4><p>With a disclosure obligation already live, and a board asking for the strategy behind the numbers it signs.</p><span class="lk">Request a Proposal →</span></div>
      <div class="pc2 reveal"><div class="ic">◆</div><h4>Mid-market entering ESG</h4><p>Pulled in by customers, lenders or investors. We size the first programme to your obligations — not to an enterprise template.</p><span class="lk">Request a Proposal →</span></div>
      <div class="pc2 reveal"><div class="ic">⬡</div><h4>Groups &amp; portfolios</h4><p>Investor-mandated programmes across multiple entities — one strategy, consistently governed and measured.</p><span class="lk">Request a Proposal →</span></div>
    </div>
  </div>
</section>
...
<section class="sec final" id="cta">
  <div class="wrap">
    <h2 class="reveal">Bring us the question your board asked.</h2>
    <p class="reveal">Tell us where ESG sits in your business today and what is driving the ask. A specialist scopes a proposal — a real person, not a form receipt.</p>
    <div class="hero-cta reveal">
...
<section class="sec" id="faq">
  <div class="wrap">
    <div class="sec-head reveal"><span class="mono eyebrow">Common questions</span><h2>ESG strategy, briefly.</h2></div>
