...
<header class="shero start-hero" id="top">
  ...
  <div class="wrap"><div class="shero-in">
    ...
    <p class="lede reveal">Tell us what is prompting this. In two minutes you'll have a specialist working on a first read of what your situation requires — and a proposed scope for a short call. <span class="g">Not a quote yet, and no obligation.</span></p>
    ...
    <div class="ws-grid">
      <div class="form-card" id="fcard">
        ...
        <div class="fstep" data-step="1">
          ...
          <div class="fld"><label>Who are you? <span class="req">required</span></label>
            <div class="opts cols2" data-group="band">
              <div class="opt" data-val="lender">Lender, DFI or project financier</div>
              <div class="opt" data-val="investor">Investor or PE deal team</div>
              <div class="opt" data-val="sponsor">Project sponsor or borrower</div>
              <div class="opt" data-val="training">Training buyer</div>
          ...
          <div class="divert-note" id="divertNote" hidden>Not sure what applies yet? <a href="/solutions">Browse the solutions</a> to see the shape of the work — or send this form anyway and a specialist will help you scope it.</div>
        </div>
        ...
        <div class="fstep" data-step="2" hidden>
          ...
          <div class="fld"><label>Sector <span class="hint">optional</span></label><input type="text" id="sector" placeholder="e.g. manufacturing, financial services, energy"></div>
          ...
          <div class="fld"><label>Anything specific? <span class="hint">optional</span></label><textarea id="note" rows="3" placeholder="A line on what's prompting this — skip anything you'd rather not share."></textarea></div>
        </div>
        ...
        <div class="fstep" data-step="3" hidden>
          ...
          <div class="fld two"><div><label>Phone <span class="hint">optional</span></label><input type="tel" id="phone" placeholder="+91"></div><div><label>Role <span class="hint">optional</span></label><input type="text" id="role" placeholder="e.g. Head of ESG"></div></div>
          <label class="consent"><input type="checkbox" id="consent"> <span>I agree to be contacted about my request. <a href="/privacy">Privacy Policy</a>.</span></label>
        </div>

        <div class="submit-err" id="submitErr" role="alert" hidden></div>
      ...
      <div class="form-card confirm" id="confirmCard" hidden>
        ...
        <p>A specialist reviews your context and replies within <b>two business days</b> with (1) a first read on what your situation actually requires and (2) a proposed scope for a short call — not a quote yet.</p>
        <div class="conf-lane" id="confLane">We'll lead with what your situation requires first.</div>
        <p class="conf-alt">While you wait, <a href="/solutions">browse the solutions</a> to see the shape of the work. <span class="conf-fallback">Trouble sending? Email <a href="mailto:contact@teravora.in">contact@teravora.in</a> and we'll pick it up.</span></p>
      </div>
      ...
      <div class="spec-wrap">
        <div class="spec" id="spec">
          ...
          <div class="srow"><span class="sk">PROFILE</span><span class="sv" id="sv-band">—</span></div>
        ...
        <div class="reassure">
          <div class="rz"><span class="ic">◷</span><div><b>Reply within two business days.</b><p>A first read on what your situation requires, plus a proposed scope for a short call.</p></div></div>
...
<section class="sec faqsec" id="faq">
  <div class="wrap">
    ...
    <div class="faq reveal">
      <div class="qa"><button type="button">Is this a quote? <span class="pl">+</span></button><div class="a"><p>No. You'll get a first read on what your situation actually requires and a proposed scope for a short call &mdash; not a number. Pricing follows only once the scope is agreed, so it reflects the work, not a guess.</p></div></div>
      ...
      <div class="qa"><button type="button">What if I'm not sure what applies to us? <span class="pl">+</span></button><div class="a"><p>That's a valid starting point &mdash; choose <i>&ldquo;Not sure yet&rdquo;</i> and we'll help you work out what actually reaches you, whether that is a lender's IFC or Equator condition, a deal's diligence scope, or an India disclosure duty.</p></div></div>
      <div class="qa"><button type="button">Who sees the information I share? <span class="pl">+</span></button><div class="a"><p>Only the specialist reviewing your request. Your details are used to prepare your first read and to reach you about it &mdash; nothing else, and never sold. See our <a href="/privacy">Privacy Policy</a>.</p></div></div>
    </div>
  </div>
</section>`;
