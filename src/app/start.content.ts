  ...
  <div class="wrap">
    <div class="ws-grid">
      ...
      <div class="form-card confirm" id="confirmCard" hidden>
        ...
        <p class="conf-alt">While you wait, <a href="/solutions">browse the solutions</a> to see the shape of the work. <span class="conf-fallback">Trouble sending? Email <a href="mailto:proposal@teravora.in">proposal@teravora.in</a> and we'll pick it up.</span></p>
      </div>
